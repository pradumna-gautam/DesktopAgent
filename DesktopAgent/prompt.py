operation_prompt = '''This is the current screenshot. Please give me the response as requested below.
...
1. open App (parameter). Click on the name of an App on your desktop. The parameter is the name of the App. You can only use this action on the desktop.
...
3. click icon (parameter1, parameter2). The parameter1 is the description of the icon you want to click, please use this template: [color][shape], such as red circle. The parameter2 is selected from top, bottom, left, right, and center, representing the general location of the icon on the screenshot.
4. page down, page up. These two commands don't need a parameter and are used for page turning.
5. type (parameter). The parameter is what you want to type. Make sure you have clicked on the input box before typing.
6. back. Go back to the previous page.
...
choose_operation_prompt = '''This is the current screenshot. Please give me the action.
